...
export default function ConfirmEmailES({
  nombre,
  actividad,
  codigoReserva,
  fecha,
  ...
  return {
    subject: `Tu reserva para ${actividad} ha sido confirmada`,
    html: `
      <!DOCTYPE html>
      <html lang="es">
        <head>
          ...
          <title>Confirmación de Reserva - ${nombreComercial}</title>
          <style>
        ...
        <body>
          <div class="email-container">
            <div class="email-cont2">
              ...
              <div class="confirmation-message">¡Tu reserva está confirmada!</div>
              ...
              <div class="section">
                ...
                ${tarifas
                  .map(
                    (tarifa) =>
                      `<div class="item"><img class="checkbox" src="https://stg.getfloraplus.com/icons/mails/group.png" alt="Participantes" style="width: 19px; height: 12px; margin-right: 10px; vertical-align: middle;" /> ${tarifa}</div>`
                  )
                  .join("")}
              </div>
              ...
              ${
                ...
                <div class="section">
                  ...
                  ${adicionales
                    .map(
                      (extra) =>
                        `<div class="item"><img class="checkbox" src="https://stg.getfloraplus.com/icons/mails/cart.png" alt="Adicionales" style="width: 17px; height: 17px; margin-right: 10px; vertical-align: middle;" /> ${extra}</div>`
                    )
                    .join("")}
                </div>
                `
              ...
              <div class="section">
                ...
                <div class="item">
                  <img class="checkbox" src="https://stg.getfloraplus.com/icons/mails/bill.png" alt="Precio total" style="width: 15px; height: 17px; margin-right: 10px; vertical-align: middle;" />
                  ${precioTotal}
                </div>
              </div>
            </div>
            ...
            <div class="contact-info">
              ...
              <div>
                <p style="font-size: 20px; font-weight: 400;">Contactanos</p>
              </div>
              ${
                telefonoContacto
